...
class Flow(models.Model):
    ...
    recruiter = models.ForeignKey(Recruiter, on_delete=models.CASCADE, related_name='created_flows')
    name = models.CharField(max_length=255)
    description = models.TextField(blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class Interview(models.Model):
    ...
    step = models.ForeignKey(Step, on_delete=models.CASCADE, related_name='interviews')
    interviewer = models.ForeignKey(Recruiter, on_delete=models.SET_NULL, null=True, related_name='conducted_interviews')
    ...
    class Meta:
        unique_together = ['candidate', 'step']  # A candidate can only do each step once
