...
from .models import Company, Candidate, Flow, Step, Interview
...
class FlowAPITests(APITestCase):
    ...
    def test_create_candidate(self):
        ...
        self.assertEqual(Candidate.objects.get(id=response.data['id']).email, 'jane@example.com')
    ...
    def test_create_interview(self):
        ...
        self.assertEqual(Interview.objects.get(id=response.data['id']).status, 'pending')
